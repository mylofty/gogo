<template><div><nav class="table-of-contents"><ul><li><router-link to="#一、缓存常见问题">一、缓存常见问题</router-link></li><li><router-link to="#二、缓存一致性问题">二、缓存一致性问题</router-link><ul><li><router-link to="#_2-1-缓存更新策略">2.1 缓存更新策略</router-link></li><li><router-link to="#_2-2-旁路缓存-cache-aside">2.2 旁路缓存(cache aside)</router-link></li><li><router-link to="#_2-3-写穿-write-through">2.3 写穿(write through)</router-link></li><li><router-link to="#_2-4-异步写回-write-behind">2.4 异步写回(write behind)</router-link></li></ul></li><li><router-link to="#三、缓存雪崩、击穿、穿透问题">三、缓存雪崩、击穿、穿透问题</router-link><ul><li><router-link to="#_3-1-缓存雪崩">3.1 缓存雪崩</router-link></li><li><router-link to="#_3-2-缓存击穿">3.2 缓存击穿</router-link></li><li><router-link to="#_3-3-缓存穿透">3.3 缓存穿透</router-link></li></ul></li></ul></nav>
<h1 id="缓存一致性" tabindex="-1"><a class="header-anchor" href="#缓存一致性"><span>缓存一致性</span></a></h1>
<h2 id="一、缓存常见问题" tabindex="-1"><a class="header-anchor" href="#一、缓存常见问题"><span>一、缓存常见问题</span></a></h2>
<ol>
<li>缓存与数据库数据一致性</li>
<li>缓存雪崩</li>
<li>缓存击穿</li>
...
<h2 id="二、缓存一致性问题" tabindex="-1"><a class="header-anchor" href="#二、缓存一致性问题"><span>二、缓存一致性问题</span></a></h2>
...
<h3 id="_2-1-缓存更新策略" tabindex="-1"><a class="header-anchor" href="#_2-1-缓存更新策略"><span>2.1 缓存更新策略</span></a></h3>
...
<h3 id="_2-2-旁路缓存-cache-aside" tabindex="-1"><a class="header-anchor" href="#_2-2-旁路缓存-cache-aside"><span>2.2 旁路缓存(cache aside)</span></a></h3>
...
<img src="/images/缓存一致性.jpeg" alt="img"></p>
<h3 id="_2-3-写穿-write-through" tabindex="-1"><a class="header-anchor" href="#_2-3-写穿-write-through"><span>2.3 写穿(write through)</span></a></h3>
...
<h3 id="_2-4-异步写回-write-behind" tabindex="-1"><a class="header-anchor" href="#_2-4-异步写回-write-behind"><span>2.4 异步写回(write behind)</span></a></h3>
...
<h2 id="三、缓存雪崩、击穿、穿透问题" tabindex="-1"><a class="header-anchor" href="#三、缓存雪崩、击穿、穿透问题"><span>三、缓存雪崩、击穿、穿透问题</span></a></h2>
...
<h3 id="_3-2-缓存击穿" tabindex="-1"><a class="header-anchor" href="#_3-2-缓存击穿"><span>3.2 缓存击穿</span></a></h3>
<p>某个访问非常频繁的热点数据，无法在缓存中处理，导致该数据的大量请求，一下子发送到了数据库</p>
<ol>
<li>热点数据过期
解决办法：热点数据不设置过期</li>
</ol>
<h3 id="_3-3-缓存穿透" tabindex="-1"><a class="header-anchor" href="#_3-3-缓存穿透"><span>3.3 缓存穿透</span></a></h3>
